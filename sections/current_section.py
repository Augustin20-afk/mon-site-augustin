...
def render_current() -> None:
    ...
    if b64:
        logo_html = f'<img src="data:image/png;base64,{b64}" style="height:48px;width:auto;object-fit:contain;" alt="Coloplast">'
    ...
    ">
        ...
        ">
            <div style="display:flex;align-items:center;gap:1.2rem;margin-bottom:1.5rem;">
                {logo_html}
                <div>
                    <h3 style="font-size:1.3rem;font-weight:700;color:#0f172a;margin-bottom:0.2rem;">Coloplast</h3>
                    <p style="font-size:0.95rem;color:#2563eb;font-weight:600;">Alternant Acheteur Projet</p>
                </div>
            </div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:0.6rem;padding-top:1.2rem;border-top:1px solid #f1f5f9;">
                <span style="background:#eff6ff;color:#2563eb;font-size:0.82rem;font-weight:600;padding:0.35rem 0.8rem;border-radius:999px;">⚙️ Achats projets</span>
                <span style="background:#eff6ff;color:#2563eb;font-size:0.82rem;font-weight:600;padding:0.35rem 0.8rem;border-radius:999px;">🤝 Coordination transverse</span>
                <span style="background:#eff6ff;color:#2563eb;font-size:0.82rem;font-weight:600;padding:0.35rem 0.8rem;border-radius:999px;">📊 Analyse &amp; structuration</span>
                <span style="background:#eff6ff;color:#2563eb;font-size:0.82rem;font-weight:600;padding:0.35rem 0.8rem;border-radius:999px;">🌍 Environnement international</span>
            </div>
        </div>
    </div>
    """
